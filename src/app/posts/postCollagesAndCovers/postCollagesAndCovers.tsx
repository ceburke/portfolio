  ...
  return (
    <>
      <ExtendedPostTitle
        ...
        description="Collage has always been one of my favorite creative mediums, whether working digitally or with physical materials. Collage offers quick entry into endless opportunities for exploration, making it a medium where imagination can truly run wild.
