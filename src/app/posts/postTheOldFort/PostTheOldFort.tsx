    ...
    <>
      ...
      <div className="*:my-5">
        ...
        <p>
          ...
          that allowed for customization and faster development. To align the visual identity with
          the Old Fort’s mission, I collaborated closely with FLC‘s photographer and videographer to
      ...
      <div className="*:my-5">
        ...
        <p>
          ...
          site’s structure. Using Google Analytics to identify the most viewed pages, I proposed a
          new sitemap that addressed content gaps. After stakeholder review and alignment, I focused
          on developing user-friendly content formats to make the Old Fort’s extensive resources
      ...
      <div className="*:my-5">
        ...
        <p>
          ...
          stakeholders, and hours of manual input. Dividing the work into sprints made the effort
          more efficient and less overwhelming. Two specific areas required additional iteration and
          research:
        </p>
      </div>
      <Double>
